-- Test-Seed: 2 Wochen Regelarbeitszeit (Mo–Fr, 8 h) auf einer Baustelle
-- „neuer Test" für hallo@epowergmbh.at. Idempotent — überspringt bereits
-- vorhandene Tage und macht nichts, wenn das Profil nicht existiert (damit
-- fremde/frische Datenbanken nicht brechen).
...
BEGIN
  ...
  IF v_ma IS NULL THEN
    RAISE NOTICE 'Seed übersprungen: hallo@epowergmbh.at nicht vorhanden';
    RETURN;
  END IF;
