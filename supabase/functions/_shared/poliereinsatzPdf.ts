// KOPIE von src/lib/poliereinsatzPdf.ts für die Edge Function einsatzplan-pdf (Deno).
// Bei Änderungen am Bildschirm-PDF dort auch hier nachziehen (nur die zwei Imports unterscheiden sich).
/**
...
import { isWerktag } from "./feiertage.ts";
