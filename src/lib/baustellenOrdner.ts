...
export const BAUSTELLEN_ORDNER: OrdnerDef[] = [
  { key: "1-baustellenmanagement", label: "Baustellenmanagement", color: "#dc2626" },
  { key: "2-schriftverkehr", label: "Schriftverkehr", color: "#0ea5e9" },
  { key: "3-aktenvermerke", label: "Aktenvermerke", color: "#8b5cf6" },
  { key: "4-vertrag", label: "Vertrag", color: "#10b981" },
  { key: "5-subunternehmer", label: "Subunternehmer / Professionisten", color: "#f59e0b" },
  { key: "6-abrechnung", label: "Abrechnung", color: "#ef4444" },
  { key: "7-lieferanten", label: "Lieferanten", color: "#06b6d4" },
  { key: "8-kalkulation", label: "Kalkulation", color: "#84cc16" },
  { key: "91-plaene", label: "Pläne", color: "#7c3aed" },
  { key: "92-sonstiges", label: "Sonstiges", color: "#6b7280" },
  { key: "93-dhp", label: "DHP", color: "#ec4899" },
  { key: "94-statik", label: "Statik", color: "#14b8a6" },
